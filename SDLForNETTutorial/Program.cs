...
public class SDL
{
    ...
    private static void LoadImages()
    {
        ...
        DrawWuLine(5, 80, 15, 80, Color.Tomato);
        DrawWuLine(10, 80, 10, 95, Color.Tomato);
        DrawWuLine(17, 80, 22, 95, Color.Tomato);
        BrezengamLine(22, 95, 27, 80, Color.Tomato);
        NonSymCDALine(29, 80, 29, 95, Color.Tomato);
        BrezengamLine(29, 95, 36, 80, Color.Tomato);
        NonSymCDALine(36, 80, 36, 95, Color.Tomato);
